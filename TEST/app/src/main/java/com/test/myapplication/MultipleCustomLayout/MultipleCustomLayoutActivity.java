 ...
 */
public class MultipleCustomLayoutActivity extends AppCompatActivity {

    @NonNull
    public static Intent createIntent(@NonNull Context context) {
        return new Intent(context, MultipleCustomLayoutActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("multiple custom layout");
    ...
    private void loadFile() throws JSONException {
        ...
        try {
            ...
            MultipleCustomLayoutAdapter adapter = new MultipleCustomLayoutAdapter(this);
